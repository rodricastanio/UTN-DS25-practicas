...
async function main() {
  ...
  const books = [
    ...
    // TERROR
    {
      ...
      genero: "Terror",
      descripcion:
        "Niños con poderes especiales son secuestrados y llevados a un siniestro institute donde se experimenta con ellos. Terror psicológico y suspenso.",
  ...
  // Insertar generos (coinciden con los destacados usados en el frontend)
  const generos = [
    {
      id: 'romance',
      nombre: 'Romance',
      destacadoTitulo: 'HeartStopper',
      destacadoAutor: 'Por Alice Oseman',
      destacadoImagen: '/imagenes/PortadaHeartStopper.jpeg',
    },
    {
      id: 'psicologia',
      nombre: 'Psicología',
      destacadoTitulo: 'Psicopatologia de la vida cotidiana',
      destacadoAutor: 'Por Sigmund Freud',
      destacadoImagen: '/imagenes/PortadaCotidiana.gif',
    },
    {
      id: 'terror',
      nombre: 'Terror',
      destacadoTitulo: 'El instituto',
      destacadoAutor: 'Por Stephen King',
      destacadoImagen: '/imagenes/PortadaInstituto.jpeg',
    },
    {
      id: 'cienciaficcion',
      nombre: 'Ciencia Ficción',
      destacadoTitulo: 'El problema de los 3 cuerpos',
      destacadoAutor: 'Por Cixin Liu',
      destacadoImagen: '/imagenes/Portada3Cuerpos.jpeg',
    },
  ];
